...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: [
      ...
      "<div style='display:flex;gap:16px;justify-content:center;margin:32px 0;flex-wrap:wrap'><img src='/blog/logos%20canvas%20ia-bof.png' alt='Logos générés par Canva IA' style='width:240px;border-radius:12px;border:1px solid #e5e7eb'/><img src='/blog/47%20Logos%20g%C3%A9n%C3%A9r%C3%A9s.%20pas-mon%20ident.png' alt='47 logos générés - pas mon identité' style='width:240px;border-radius:12px;border:1px solid #e5e7eb'/></div>",
