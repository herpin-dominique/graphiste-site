...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: [
      ...
      "<div style='display:flex;gap:24px;align-items:center;justify-content:center;margin:32px 0;flex-wrap:wrap'><div style='text-align:center'><img src='/blog/logo-data2000-1980.svg' alt='Logo DATA 2000 style années 80' style='width:280px;border-radius:8px'/><p style='font-size:12px;color:#9ca3af;margin-top:8px'>Style années 80 — illisible, daté</p></div><div style='font-size:32px;color:#7c3aed;font-weight:bold'>→</div><div style='text-align:center'><img src='/blog/logo-data2000-2026.svg' alt='Logo DATA 2000 modernisé 2026' style='width:280px;border:1px solid #e5e7eb;border-radius:8px'/><p style='font-size:12px;color:#9ca3af;margin-top:8px'>Refonte 2026 — épuré, mémorable</p></div></div>",
