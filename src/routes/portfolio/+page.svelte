...
<a
  href="/"
  class="inline-block mb-8 bg-blue-600 text-white font-semibold px-8 py-3 rounded hover:bg-blue-700 transition"
>
  ← Retour à l'accueil
</a>
...
<main class="p-6 max-w-7xl mx-auto">
  <h1 class="text-5xl font-extrabold mb-12 text-gray-900">Portfolio</h1>
  ...
  {#if selectedPhoto}
    <div
      ...
      class="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50 p-4 cursor-pointer"
      tabindex="0"
      on:click={closeModal}
      on:keydown={handleBackdropKeyDown}
    >
      <div
        class="max-w-5xl max-h-full overflow-auto rounded-lg shadow-xl cursor-auto"
