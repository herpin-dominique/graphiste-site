<script lang="ts">
  ...
  function openModal(projectTitle: string, photo: string) {
...
>
  ...
  <div class="text-center mb-16 lg:mb-20">
    ...
    >
      Logos, chartes graphiques, édition, packaging et motion design — une
      sélection de projets réalisés pour des clients en Normandie et au-delà.
    </p>
  </div>

  <!-- Filtres par catégorie -->
  <div class="flex flex-wrap justify-center gap-3 mb-12 lg:mb-16">
    {#each tags as tag}
      <button
